...
| `find_invgamma_parms`  | Find shape and rate parameters of the Inverse Gamma distribution that either tries to match two user-specified quantiles, or else finds an Inverse Gamma distribution that matches a priori confidence in \eqn{R^2}. | | |
